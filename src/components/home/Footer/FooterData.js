...
export default [
  ...
  },
  {
    ...
    infos:[
      {
        icon: <FontAwesomeIcon className='info-icons' icon={['fas', 'map-marker-alt']} />,
      ...
      {
        icon: <FontAwesomeIcon className='info-icons' icon={['fas', 'phone-alt']} />,
        info:'+91 9643073391, +91-8860610495'
      },
      {
        icon: <FontAwesomeIcon className='info-icons' icon={['fas', 'envelope']} />,
        info: 'info@siscertifications.co.in, support@siscertifications.com'
      },
      {
        icon: <FontAwesomeIcon className='info-icons' icon={['fab', 'whatsapp']} />,
        info:'+91-8860610495'
      }
