		...
		<div>
			...
			<div className="accreditation-grid">
				...
				<div className="download-certificate">
					<div className="ioas">
						<h5>
							IOAS (International Organization for Accreditation Services)
						</h5>
						<div>
				...
				<div className="img-accr">
					<img src={img1} />
					<p>
						How to Get ISO 9001, ISO 14001, OH&S 18001, ISO 22000, ISO 13485,
						ISO 27001 and Other Certifications Easily?
					</p>
				</div>
